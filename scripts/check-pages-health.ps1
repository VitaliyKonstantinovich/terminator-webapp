param(
  ...
  [string]$ExpectedAssetMarker = "20260529-product-loop4-final-experience-v1",
  [string]$ExpectedCacheMarker = "terminator-mina-pwa-20260529-product-loop4-final-experience-v1"
)
