param(
  ...
  [string]$ExpectedAssetMarker = "20260529-product-loop5-visual-parity-v1",
  [string]$ExpectedCacheMarker = "terminator-mina-pwa-20260529-product-loop5-visual-parity-v1"
)
