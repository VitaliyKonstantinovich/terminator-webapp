const MINA_CACHE = 'terminator-mina-pwa-20260528-phase20-continuity-teleport-v1';

const PRECACHE_URLS = [
  './',
  './index.html',
  './styles.css?v=20260528-phase20-continuity-teleport-v1',
  './app.js?v=20260528-phase20-continuity-teleport-v1',
