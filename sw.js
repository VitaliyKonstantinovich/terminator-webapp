const MINA_CACHE = 'terminator-mina-pwa-20260527-phase16-live-heartbeat-acceptance-v1';

const PRECACHE_URLS = [
  './',
  './index.html',
  './styles.css?v=20260527-phase16-live-heartbeat-acceptance-v1',
  './app.js?v=20260527-phase16-live-heartbeat-acceptance-v1',
