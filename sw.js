const MINA_CACHE = 'terminator-mina-pwa-20260528-phase19-handoff-route-planner-v1';

const PRECACHE_URLS = [
  './',
  './index.html',
  './styles.css?v=20260528-phase19-handoff-route-planner-v1',
  './app.js?v=20260528-phase19-handoff-route-planner-v1',
